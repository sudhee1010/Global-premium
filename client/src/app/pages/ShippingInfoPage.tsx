  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card className="mb-12 p-8 bg-gradient-to-r from-[#F7931A] to-orange-600 text-white border-0">
            ...
            {shippingMethods.map((method, index) => {
              ...
              return (
                <Card key={index} className="p-6">
                  <div className="mb-4">
                    <Icon className="size-10 text-[#F7931A] mb-3" />
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Free on:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <Card className="p-6">
            <Clock className="size-10 text-[#F7931A] mb-4" />
          ...
          <Card className="p-6">
            <MapPin className="size-10 text-[#F7931A] mb-4" />
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
              Package Tracking
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            <Globe className="size-8 text-[#F7931A]" />
